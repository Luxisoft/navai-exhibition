...
> Requisito obligatorio: antes de usar Mobile, debes implementar y tener operativo el backend API de NAVAI (`/navai/realtime/client-secret`, `/navai/functions`, `/navai/functions/execute`).
...
## 5) Generacion de module loaders
